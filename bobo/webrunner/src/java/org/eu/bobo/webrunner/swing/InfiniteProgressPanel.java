...
/**
 * 18:12 17/02/2005 Romain Guy romain.guy at jext.org Subject to the BSD
 * license.  This file is the work of Romain Guy from
 * http://jroller.com/comments/gfx?anchor=with_style_followup
 */
...
/**
 * An infinite progress panel displays a rotating figure and a message to
 * notice the user of a long, duration unknown task. The shape and the text
 * are drawn upon a white veil which alpha level (or shield value) lets the
 * underlying component shine through. This panel is meant to be used asa
